...
//                    canvas.fillOval((int) (markerCenter.getX() - markerSize / 2),
//                            (int) (markerCenter.getY() - markerSize / 2),
...
//        }
    ...
    public void displayGraphics(double[][] graphicsData) {     //线条
...
private void paintLabels(Graphics2D canvas) {
    ...
    private void paintGrid(Graphics2D canvas) {  //背景
...
protected void paintMarkers(Graphics2D canvas) {     //标点
